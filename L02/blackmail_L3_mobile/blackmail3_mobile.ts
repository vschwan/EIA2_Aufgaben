namespace L02_BlackmailerCompanion_mobile {
    ...
    //gucken, ob pointer oder mouse event

    /*let keyboard: HTMLDivElement = <HTMLDivElement>document.querySelector("#keyboard");
    keyboard.addEventListener("click", function (_event: Event) {

        console.log("Sorry! preventDefault() won't let you click this! Use your finnggger");
