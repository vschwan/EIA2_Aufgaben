namespace L11_Virus {
    ...
    export class HumanCell extends Moveable {
       ...
       public checkifHit(_posvirus: Vector, _radiusvirus: number): boolean {
   ...
   */
        ...
        private drawinfected(): void {
            ...
            let gradient: CanvasGradient = crc2.createRadialGradient(0, 0, 3, 0, 0, HumanCell.radius);
            crc2.save();
            crc2.translate(this.position.x, this.position.y);
            crc2.beginPath();
            crc2.arc(0, 0, HumanCell.radius - 10, 0, 2 * Math.PI);
            crc2.closePath();
        ...
        private drawhealthy(): void {
            ...
            crc2.translate(this.position.x, this.position.y);
            crc2.beginPath();
            crc2.arc(0, 0, HumanCell.radius, 0, 2 * Math.PI);
            crc2.closePath();
