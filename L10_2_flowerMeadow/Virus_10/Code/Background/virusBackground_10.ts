namespace L10_Virus {
    ...
    export class Background {
        ...
        drawBloodpipe(): void {
            ...
            crc2.save();
            crc2.beginPath();
            crc2.moveTo(this.position.x - 10, canvas.height / 1.5); //startpoint (links oben)
            ...
            crc2.lineTo(this.position.x - 10, canvas.height);
            ...
            crc2.save();
            crc2.beginPath();
            crc2.moveTo(this.position.x - 10, this.position.y + 50); //startpoint (links oben)
            ...
            crc2.lineTo(this.position.x - 10, this.position.y - 550); //links unten
