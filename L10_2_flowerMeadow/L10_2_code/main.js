...
(function (L10_2_FlowerMeadow) {
    ...
    function drawBackground() {
        ...
        sun.drawSun();
        let posCloud1 = new L10_2_FlowerMeadow.Vector(650, 100);
        let sizeCloud1 = new L10_2_FlowerMeadow.Vector(200, 30);
        let cloud1 = new L10_2_FlowerMeadow.Cloud(posCloud1, sizeCloud1);
        cloud1.draw();
        ...
        let posCloud2 = new L10_2_FlowerMeadow.Vector(150, 180);
        let sizeCloud2 = new L10_2_FlowerMeadow.Vector(100, 20);
        let cloud2 = new L10_2_FlowerMeadow.Cloud(posCloud2, sizeCloud2);
        cloud2.draw();
        ...
        let posCloud3 = new L10_2_FlowerMeadow.Vector(300, 120);
        let sizeCloud3 = new L10_2_FlowerMeadow.Vector(180, 30);
        let cloud3 = new L10_2_FlowerMeadow.Cloud(posCloud3, sizeCloud3);
        cloud3.draw();
